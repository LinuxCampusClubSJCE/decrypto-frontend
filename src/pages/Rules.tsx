...
const Rules = () => {
    const data = [
        ...
        'Know a fair bit about college, movies, series, famous people, companies, sports, places, games, and some tech stuff, or might be friends with people who know about these things',
